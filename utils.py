...
tf.app.flags.DEFINE_integer('cnn_count', 2, 'count of cnn module to extract image features.')
...
tf.app.flags.DEFINE_integer('num_epochs', 10, 'maximum epochs')
...
tf.app.flags.DEFINE_integer('max_stepsize', 28, 'max_stepsize to lstm')
...
tf.app.flags.DEFINE_string('infer_dir', './imgs/test/', 'the infer data dir')
    ...
    def __init__(self, data_dir):
        ...
        for root, sub_folder, file_list in os.walk(data_dir):
            for file_path in file_list:
                ...
                code = image_name.split('/')[-1].split('_')[1].split('.')[0]#abcd
